      ...
      <div class="d-flex flex-column  flex-wrap">
        <form class="container d-flex flex-wrap my-2 border-bottom pb-5" action="api/reg.php" method="post">
          <div class="col-md-3 col-12 form-floating mb-4 bgShadow">
            <input type="text" class="form-control border-0" id="acc" name="acc" placeholder="your account" required>
          ...
          <div class="col-md-4 col-12 offset-md-1 form-floating mb-4 bgShadow">
            <input type="date" class="form-control border-0" id="bitth" name="bitth" placeholder="your birthday" minlength="8"
              maxlength="12" required>
            <label for="bitth">生日</label>
          </div>
